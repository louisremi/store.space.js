...
/* Copyright (c) 2011 @louis_remi */
(function(c,a,i){var h=a.length;c.space=function(g){var d=c.get(g),f="",b=function(e,b){if(b===i)return c.get(d+"-"+e);else~(a+f+a).indexOf(a+e+a)||c.set(d+"_index",f+=(f?a:"")+e),c.set(d+"-"+e,b)};b.remove=function(e){c.set(d+"_index",(a+f+a).split(a+e+a).join(a).slice(h,-h));c.remove(d+"-"+e)};b.clear=function(){for(var e=f.split(a),b=e.length;b--;)c.remove(d+"-"+e[b]);c.remove(d+"_index")};b.get=b.set=b;d?f=c.get(d+"_index"):(d=g+"-"+(Math.random()*1E4|0),c.set(g,d));return b}})(store,"#_s_#");